    ...
    <body background="images/prosegurFondo.jpg" style="width:100%; text-align:center; margin-top:50px;">
        ...
        <html:form action="/naturalezas" >
            ...
            <table  style="width:100%; text-align:center;" id="dataTable" >
                ...
                <c:forEach var="nat" items="${NaturalezasForm.lista}">
                        <tr>
                            <td ><img src="images/delete.png" width="20" height="20" alt="delete" onclick="borrar(${nat.id});"/>
                            </td>
                            <td ><font color="black"><c:out value="${nat.descripcion}"/></font></td>
                        </tr>
                 </c:forEach>  
            </table>  
            </div>    
